...
\begin{figure}[htbp]
\centering
\subfloat[子图一]{\includegraphics[width=0.28\textwidth]{figures/DECAF1}\label{fig:a}}
\qquad
\subfloat[子图二]{\includegraphics[width=0.28\textwidth]{figures/DECAF6}\label{fig:b}}
\caption{多子图排版示例}
\label{fig:subfigs}
\end{figure}
